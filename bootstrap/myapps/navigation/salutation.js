        ...
        success: function(reponse, status){
            ...
            if ((agent['PASSWORD'] === "0000") || (agent['PASSWORD'] === 'default')){
                ...
                function magimagie(){
                    ...
                    var message = `Bonjour `+formalit+` `+agent['NOM_UTIL_AG']+`, Bienvenu sur GPS, Une application de Gestion du Patrimoine
                    et de Stock. L'utilisation de cette application nécessite l'utilisation des comptes personneles. Prémièrement, pour relier 
                    l'application à votre siuation dans le système de gestion physique. Deuxièmement, suivre vos activités au sein de l'application.
                    Votre comptes sera protégé par une système d'authentification qui est réquis au début de chaque session d'utilisation.
                    ...
                    Voulez vous changer le mot de passe maintenant?`
