    ...
    class DemandeModel extends CI_Model{
        ...
        public function getDemande_data(){
            ...
            if ($tp !='USER'){
                ...
                DEMANDE.QUANTITE, DEMANDE.UNITE, DEMANDE.ETAT_DEMANDE, AGENT.MATRICULE, AGENT.NOM_AG, AGENT.NOM_UTIL_AG, AGENT.PRENOM_AG, AGENT.FONCTION_AG,
        ...
        public function validerDemande($num, $inputQte, $formule){
            ...
            // $this->db->set('ETAT_DEMANDE', "Validé");TO_DATE(TO_CHAR(SYSDATE,'HH24:MI:SS'),'HH24:MI:SS')
            // $this->db->set('QUANTITE_ACC', $inputQte);
            // $this->db->set('DATE_CONFIRM', $daty);
            // $this->db->set('QUANTITE_STOCK', $article['0']['EFFECTIF_ART']- $inputQte);
            // $this->db->set('DATE_CONFIRM', $lera);
            // $this->db->where('NUMEROTATION', $num);
