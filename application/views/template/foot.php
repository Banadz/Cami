        ...
        <!-- jQuery UI -->
        <script src="<?php echo base_url()?>/bootstrap/assets/js/plugin/jquery-ui-1.12.1.custom/jquery-ui.min.js">
        </script>
        <script
            src="<?php echo base_url()?>/bootstrap/assets/js/plugin/jquery-ui-touch-punch/jquery.ui.touch-punch.min.js">
        </script>

        <!-- jQuery Scrollbar -->
        <script src="<?php echo base_url()?>/bootstrap/assets/js/plugin/jquery-scrollbar/jquery.scrollbar.min.js">
        </script>
        ...
        <!-- Bootstrap Notify -->
        <script src="<?php echo base_url()?>/bootstrap/assets/js/plugin/bootstrap-notify/bootstrap-notify.min.js">
        </script>
    ...
    $(form).on('submit', function(e) {
        ...
        $.ajax({
            ...
            success: function(reponse) {
                console.log(reponse);
                if (reponse.success) {
                    $('tbody').prepend('<tr id="' + reponse.codediv +
                        '"><td class="service">' + reponse.codeser +
                        '</td><td class ="codedivision">' + reponse.codediv +
                        '</td><td class="labeldivision">' + reponse.labeldiv +
                        '</td><td><a href="<?php echo base_url().'affichdiv?division=';?>' +
                        reponse.codediv +
                        '" class="edit"><button id="" class="btn btn-link btn-success btn-lg" title="Modifier"><i class="fas fa-edit"></i></button></a></td><td><button type="button" value="' +
                        reponse.codediv +
                        '" class="btn btn-link btn-danger btn-lg supprimerdiv" title="Supprimer"><i class="fas fa-prescription-bottle"></i></button></td></tr>'
                    );
                    swal({
                        title: "Succès!",
    ...
    $(form).on('submit', function(e) {
        ...
        $.ajax({
            ...
            success: function(reponse) {
                console.log(reponse);
                if (reponse.success) {
                    $('tbody').prepend('<tr id="' + reponse.idcat +
                        '"><td class ="designation">' + reponse.designation +
                        '</td><td class="categorie">' + reponse.label +
                        '</td><td><a href="<?php echo base_url().'affichcat?categorie=';?>' +
                        reponse.idcat +
                        '" class="edit"><button id="" class="btn btn-link btn-success btn-lg" title="Modifier"><i class="fas fa-edit"></i></button></a></td><td><button type="button" value="' +
                        reponse.idcat +
                        '" class="btn btn-link btn-danger btn-lg supprimercat" title="Supprimer"><i class="fas fa-prescription-bottle"></i></button></td></tr>'
                    );
                    swal({
                        title: "Succès!",
