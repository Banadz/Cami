		...
		<div class="main-header">
			...
			<div class="logo-header" data-background-color="blue">
				...
				<a href="<?php echo base_url();?>Home" class="logo">
					<img src="<?php echo base_url();?>bootstrap/images/1@300x.png" width="40%" alt="navbar brand" class="navbar-brand">
				</a>
									...
									<li>
										<div class="user-box">
											...
											<div class="u-text">
												...
												<p class="text-muted"><?php echo($_SESSION['agent']['FONCTION_AG']);?></p>
											</div>
										</div>
									</li>
									<li>
										<div class="dropdown-divider"></div>
										<a class="dropdown-item" href="<?php echo  base_url(); ?>user/profil">Profile</a>
...
<?php if  ($_SESSION['agent']['PASSWORD'] == '0000' || $_SESSION['agent']['PASSWORD'] == 'default' )	{?>
	<script>
		$(document).ready(function(){
			if (window.location.href !== 'http://192.168.88.40/GPS/user/profil' && window.location.href !== 'http://192.168.88.40/GPS/Home'){
