    ...
    <body style="font-family:dejavuserif; font-size:10pt;">
        ...
        <div>
            ...
            <div class="row Heading">
                ...
                <div class="col-8 page-title en1 "
                    style="font-family:dejavuserif;margin-top:40px;margin-left:50px;position:relative;">
                    <label style="font-family:dejavuserifb; font-size:14pt; margin-left:250px;">BON POUR</label><br><br>
                    <label style="text-decoration:underline; font-weight:bold;">Structure:</label>
                    <?=($_SESSION['agent_div'][0]['LABEL_DIVISION']);?>
                    (<?=($_SESSION['agent_div'][0]['CODE_DIVISION']);?>) <br>
                ...
                <table class="fixeo">
                    ...
                    <tbody class="tboded">
                        ...
                        <tr class="tred">
                            ...
                            <td class="cellbordure" style="width=80%;" style="text-align:center;">
                ...
                <table class="tbFoot">
                    ...
                    <tbody class="tboded">
                        <tr class="tred">
                            ...
                            <td class="cellbordure" style="width=45%;padding-bottom:90px;" style="text-align:center;">
                                Chef (<?=($_SESSION['agent_ser'][0]['CODE_SER']); ?>)</td>
                            <td class="cellbordure" style="width=30%;padding-bottom:90px;" style="text-align:center;">Le
                                Dépositaire Comptable</td>
                            <td class="cellbordure" style="width=30%;padding-bottom:90px;" style="text-align:center;">
                                Agent</td>
                        </tr>
                    </tbody>
                </table>
            ...
            <div class="row footer col-12" style="width:100%;">
                <table class="tbFooter">
                    <tbody>
                        ...
                        <tr>
                            <td style="width:90%;text-align:center;border-top:0.5px solid black;padding-top:5px;">
                                <?=($_SESSION['agent_ser'][0]['LIBELLE']);?> -
                                <?=($_SESSION['agent_ser'][0]['ADRESSE']);?><br></td>
                        </tr>
                        <tr>
                            <td style="text-align:center;"> Tel: <?=($_SESSION['agent_ser'][0]['CONTACT']);?> Email:
                                srsp.hautematsiatra@mef.gov.mg<br></td>
                        </tr>
                    </tbody>
                </table>
            </div>
